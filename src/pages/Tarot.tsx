                    ...
                    <header>
                        ...
                        <nav className='navbar'>
                            <ul>
                                ...
                                <li className={`button left-button ${location.pathname === '/tarot' ? 'active-tarot' : ''}`}>
                                    <Link to="/tarot">
                                        <img src="/images/tarot.png" className='home-icon' alt='tarot'/>
                                        <p>Tarot</p>
                                    </Link>
                                </li>
                                <li className='button'>
                                    <Link to="/norse">
                                        <img src="/images/d2.ico" className='home-icon' alt='norse mythology'/>
                                        <p>Mythology</p>
                                    </Link>
                                </li>
                                <li className='button'>
                                    <Link to="/game">
                                        <img src="/images/game_art.png" className='home-icon' alt='game art'/>
                                        <p>Game Art</p>
                                    </Link>
                                </li>
                                <li className='button'>
                                    <Link to="/commissions">
                                        <img src="/images/commissions.png" className='home-icon' alt='commissions'/>
                                        <p>Commissions</p>
                                    </Link>
                                </li>
                                <li className='button'>
